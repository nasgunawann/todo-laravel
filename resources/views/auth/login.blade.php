...
<head>
    ...
    <title>Masuk - Sistem Manajemen Tugas</title>
...
<body>
    <div class="auth-wrapper">
        ...
        <div class="login-section">
            ...
            <h1 class="welcome-title">Selamat Datang,<br>Silakan Masuk.</h1>
            <p class="welcome-subtitle">Masukkan detail akun anda untuk memulai.</p>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <p class="text-secondary mb-0" style="font-size: 0.875rem;">
                    Belum punya akun? <a href="{{ route('register') }}" class="text-dark fw-bold text-decoration-none">Daftar</a>
                </p>
            </form>
        </div>
